  ...
  },
  {
    ...
    children: [
      ...
      { path: "settings", name: "Settings", component: () => import("@/views/Settings/index.vue") },
      {
        ...
        children: [
          { path: "music", name: "AdminMusic", component: () => import("@/views/admin/Music/index.vue") },
          { path: "plugins", name: "AdminPlugins", component: () => import("@/views/admin/Plugins/index.vue") },
          { path: "sources", name: "AdminSources", component: () => import("@/views/admin/Sources/index.vue") },
          { path: "users", name: "AdminUsers", component: () => import("@/views/admin/Users/index.vue") },
          { path: "artists", name: "AdminArtists", component: () => import("@/views/admin/Artists/index.vue") },
          { path: "wish", name: "AdminWish", component: () => import("@/views/admin/Wish/index.vue") },
